...
_SCHEMA: list[FieldSpec] = [
    ...
    FieldSpec("CONFIGURATION", "agent_db_integrity_check_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_stale_quarantine_enabled", "bool", True, required=False),
    ...
    FieldSpec("CONFIGURATION", "agent_candidate_simulation_interval_minutes", "int", 60, required=False, min_value=5, max_value=1440),
    FieldSpec("CONFIGURATION", "agent_candidate_simulation_max_symbols", "int", 10, required=False, min_value=1, max_value=500),
    FieldSpec("CONFIGURATION", "agent_candidate_simulation_run_after_scan", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_watchlist_policy_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_watchlist_policy_interval_minutes", "int", 60, required=False, min_value=5, max_value=1440),
    FieldSpec("CONFIGURATION", "agent_watchlist_policy_max_churn_per_run", "int", 10, required=False, min_value=0, max_value=500),
    FieldSpec("CONFIGURATION", "agent_watchlist_policy_run_after_simulation", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_quick_backtest_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_quick_backtest_interval_minutes", "int", 1440, required=False, min_value=5, max_value=10080),
    FieldSpec("CONFIGURATION", "agent_quick_backtest_max_symbols", "int", 10, required=False, min_value=1, max_value=500),
    FieldSpec("CONFIGURATION", "agent_quick_backtest_days", "int", 14, required=False, min_value=1, max_value=90),
    FieldSpec("CONFIGURATION", "agent_quick_backtest_max_strategies", "int", 6, required=False, min_value=1, max_value=20),
    FieldSpec("CONFIGURATION", "agent_quick_backtest_min_trades", "int", 1, required=False, min_value=0, max_value=100),
    FieldSpec("CONFIGURATION", "agent_full_backtest_enabled", "bool", False, required=False),
    FieldSpec("CONFIGURATION", "agent_full_backtest_interval_minutes", "int", 1440, required=False, min_value=15, max_value=10080),
    FieldSpec("CONFIGURATION", "agent_full_backtest_hour_utc", "int", 2, required=False, min_value=0, max_value=23),
    FieldSpec("CONFIGURATION", "agent_backfill_min_interval_minutes", "int", 240, required=False, min_value=1, max_value=10080),
    FieldSpec("CONFIGURATION", "agent_daily_report_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_daily_report_hour_utc", "int", 0, required=False, min_value=0, max_value=23),
    FieldSpec("CONFIGURATION", "agent_research_automation_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_research_sweep_hour_utc", "int", 1, required=False, min_value=0, max_value=23),
    FieldSpec("CONFIGURATION", "agent_research_max_symbols", "int", 10, required=False, min_value=1, max_value=200),
    FieldSpec("CONFIGURATION", "agent_research_backtest_days", "int", 14, required=False, min_value=1, max_value=90),
    FieldSpec("CONFIGURATION", "agent_research_max_strategies", "int", 6, required=False, min_value=1, max_value=20),
    FieldSpec("CONFIGURATION", "agent_research_min_trades", "int", 1, required=False, min_value=0, max_value=200),
    FieldSpec("CONFIGURATION", "agent_canary_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_canary_exposure_pct", "float", 0.10, required=False, min_value=0.0, max_value=1.0),
    FieldSpec("CONFIGURATION", "agent_canary_reject_rate_pct_max", "float", 10.0, required=False, min_value=0.0, max_value=100.0),
    FieldSpec("CONFIGURATION", "agent_canary_slippage_bps_max", "float", 25.0, required=False, min_value=0.0, max_value=1000.0),
    FieldSpec("CONFIGURATION", "agent_canary_drawdown_pct_max", "float", 4.0, required=False, min_value=0.0, max_value=100.0),
    FieldSpec("CONFIGURATION", "agent_canary_underperform_pct_max", "float", 5.0, required=False, min_value=0.0, max_value=100.0),
    FieldSpec("CONFIGURATION", "agent_canary_rollback_mode", "enum", "PAPER", required=False, allowed=("OFF", "ADVISORY", "PAPER", "LIVE")),
    FieldSpec("CONFIGURATION", "agent_hard_halt_supreme", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_config_tuning_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_max_config_tunes_per_day", "int", 2, required=False, min_value=0, max_value=100),
    FieldSpec("CONFIGURATION", "agent_promotion_enabled", "bool", True, required=False),
    FieldSpec("CONFIGURATION", "agent_max_promotions_per_day", "int", 1, required=False, min_value=0, max_value=100),
